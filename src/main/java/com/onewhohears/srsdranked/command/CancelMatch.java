...
public final class CancelMatch {

    public static BrigadierCommand create(final SpeedrunShowdownRanked plugin) {
        LiteralCommandNode<CommandSource> main = BrigadierCommand.literalArgumentBuilder("cancel_match")
                ...
                .then(BrigadierCommand.requiredArgumentBuilder("gameplay_id",
                        ...
                        .executes(context -> {
                            ...
                            boolean result = plugin.cancelMatch(id,
